...
public class SCSchool {
	...
	public static SCSchool schoolFromJSONObject(JSONObject schoolJSONObject)
		...
		if (createdAt == null || createdAt.equalsIgnoreCase("null"))
			school.createdAt = new Date(DateUtils.dateInMillSecond(currenttime));
		else
			school.createdAt = new Date(DateUtils.dateInMillSecond(createdAt));

		String updatedAt = propertiesObj.getString("updated_at");
		if (updatedAt == null || updatedAt.equalsIgnoreCase("null"))
			school.updatedAt = new Date(DateUtils.dateInMillSecond(currenttime));
		else
